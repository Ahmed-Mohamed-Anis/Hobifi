...
class SupabaseConfig {
  static const String supabaseUrl = 'https://cetytjbfjtpltdcfkilg.supabase.co';
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNldHl0amJmanRwbHRkY2ZraWxnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjgzMjYxMjYsImV4cCI6MjA4MzkwMjEyNn0.JwbEd6ZtwTLRj4Ia4nt8uh1t54Iu5UQlwPIL84gfHY4';
...
class SupabaseService {
  ...
  static Future<List<Map<String, dynamic>>> select(
    ...
    try {
      ...
      // Apply pagination range (offset + limit)
